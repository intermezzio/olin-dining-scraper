...
class Quotes:
    ...
    def get_quotes(self, item_list, n=1, quote_only=False, html_tags=True):
        ...
        return self._from_templates(
            bases, n=n, item_list=item_list, quote_only=quote_only, html_tags=html_tags
        )

    def _from_templates(
        self, bases, item_list=None, n=1, quote_only=False, html_tags=True
    ):
